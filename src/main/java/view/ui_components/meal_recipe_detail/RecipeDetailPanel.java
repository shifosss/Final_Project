...
public class RecipeDetailPanel extends JPanel{
    ...
    public RecipeDetailPanel(MealRecipe mealrecipe) {
        ...
        // Title
        JLabel titleLabel = new JLabel(mealrecipe.getName());
        ...
        // Image
        ImageIcon image = new ImageIcon(mealrecipe.getImageLink());
        ...
        JPanel ingredientsPanel = createIngredientsPanel(mealrecipe.getIngredients());
        ...
        JPanel instructionsPanel = createInstructionsPanel(mealrecipe.getInstruction());
