...
public class MainPageMeal extends JPanel {
    ...
    public MainPageMeal(CardLayout parentCardLayout, JPanel parentPanel) {
    ...
    private List<List<ImageIcon>> loadImageGroups() {
        ...
        List<ImageIcon> group1 = List.of(
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/image/image1.jpg"))),
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/image/image2.jpg")))
        );
        List<ImageIcon> group2 = List.of(
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/image/image3.jpg"))),
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/image/image5.jpg")))
        );
        List<ImageIcon> group3 = List.of(
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/image/image4.jpg"))),
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/image/image6.jpg")))
        );
